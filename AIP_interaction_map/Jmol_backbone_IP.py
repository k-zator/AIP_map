Jmol_backbone_IP = [
    ...
    '  data "append example"|1|IP|VS IP_POS|end "append example";show data\n',
    '\n',
    '  select ({LAR});\n',
    '  color atoms opaque [x0a9396];\n',
    '  color TRANSLUCENT 70;\n',
    '  spacefill 0.9;\n',
    '  select ({SMA});\n',
    '  color atoms opaque [x94d2bd];\n',
    '  color TRANSLUCENT 70;\n',
    '  spacefill 0.9;\n',
    '  select ({REP});\n',
    '  color atoms opaque [xe9d8a6];\n',
    '  color TRANSLUCENT 70;\n',
    '  spacefill 0.9;\n',
    '  select ({ZERO});\n',
    '  color atoms opaque [xb8b8d0];\n',
    '  color TRANSLUCENT 140;\n',
    '  spacefill 0.2;\n',
    '  measures delete;\n',
    '  draw indx ({GUEST_DIS}) ({HOST_DIS}) diameter 0.02 translucent 200 [x000000];\n',
    ';\n',
